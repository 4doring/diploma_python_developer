...
class Shop(models.Model):
    """
    Модель магазина-партнёра. Привязана к пользователю типа 'shop'.
    """
...
class Category(models.Model):
    ...
    Связана с магазинами через отношение многие-ко-многим.
    """
...
class ProductInfo(models.Model):
    """
    Конкретное предложение продукта от магазина.
    """
...
class Parameter(models.Model):
    """
    Модель названия параметра товара.
    """
...
class ProductParameter(models.Model):
    """
    Модель значения параметра для конкретного предложения продукта.
    """
